<?php
	...
	if($_POST){
		...
		if( $Return->success == true && $Return->score > .125 ) {
			...
			// mail( "ladya.kuhni@mail.ru, vasilyev-r@mail.ru", "Обратный звонок с сайта магазин-ладья.рф", "
            mail( "sidorov-vv3@mail.ru, vasilyev-r@mail.ru", "Обратный звонок с сайта магазин-ладья.рф", "
				Клиент: " . $name ."\n
				Телефон: " . $tel
			); 	
			$_SESSION['win'] = 1;
